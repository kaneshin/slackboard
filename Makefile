...
bin/slackboard: cmd/slackboard/slackboard.go slackboard/*.go
	gom build $(GOFLAGS) -o bin/slackboard github.com/kaneshin/slackboard/cmd/slackboard

bin/slackboard-cli: cmd/slackboard-cli/slackboard-cli.go slackboard/*.go
	gom build $(GOFLAGS) -o bin/slackboard-cli github.com/kaneshin/slackboard/cmd/slackboard-cli

bin/slackboard-log: cmd/slackboard-log/slackboard-log.go slackboard/*.go
	gom build $(GOFLAGS) -o bin/slackboard-log github.com/kaneshin/slackboard/cmd/slackboard-log
